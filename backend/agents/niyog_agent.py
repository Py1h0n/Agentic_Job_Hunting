"""
Niyog Job Search Agent — SaaS Edition
=====================================
...
class NiyogAgent(BaseJobAgent):
    """Niyog job scraping agent."""
